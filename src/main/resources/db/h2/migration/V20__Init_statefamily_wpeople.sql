CREATE TABLE w_wpeople (
    ...
    wIdTX VARCHAR(20) NOT NULL,
    wNameTX VARCHAR(330) NOT NULL,
    wUserNameTX VARCHAR(100) NOT NULL,
    wPositionNameTX VARCHAR(150),
    wFirstNameTX VARCHAR(150) NOT NULL,
    wFamilyNameTX VARCHAR(150) NOT NULL,
    wSurnameTX VARCHAR(150) NOT NULL,
    wMenuLI VARCHAR(1000),
    wHomePageLI VARCHAR(1000),
    wOrgNameTX VARCHAR(1000),
    wEmailTX VARCHAR(50) NOT NULL,
