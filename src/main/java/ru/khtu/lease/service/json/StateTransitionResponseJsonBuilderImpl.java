...
import ru.khtu.lease.mapper.AttributeMapper;
import ru.khtu.lease.mapper.InclusionMapper;
import ru.khtu.lease.mapper.ModuleFormMapper;
import ru.khtu.lease.mapper.StateMapperDto;
import ru.khtu.lease.mapper.helper.jackson.StateTransitionJacksonMapperHelperDto;
import ru.khtu.lease.mapper.helper.StateTransitionMapperHelperDto;
import ru.khtu.lease.mapper.helper.jackson.StateTransitionSubactionJacksonMapperHelperDto;
...
public class StateTransitionResponseJsonBuilderImpl
    ...
    public StateTransitionResponseJsonBuilderImpl(WorkObject workObject, StatemachineComponent statemachineComponent) {
        ...
        Map.Entry<
                List<StateDto>,
                List<StateTransitionFullDto> > data = this.statemachineComponent.getStateTransition(workObject);
